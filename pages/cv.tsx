    ...
    <div className='cv-container'>
      ...
      <div className='cv-section'>
        ...
        <p>
          ...
          strength is in the Typescript/Javascript ecosystem, but I am quite flexible with tech, having worked in Python
      ...
      <div className='cv-section'>
        ...
        <p>
          ...
          server using Golang and a Typescript/RxJS client library to easily adapt to the frontend teams data
          requirements.
        </p>
      </div>
      ...
      <div className='cv-section'>
        ...
        <p>
          ...
          <a href='https://quaternius.trebeljahr.com'>quaternius.trebeljahr.com</a>
        </p>
      </div>
